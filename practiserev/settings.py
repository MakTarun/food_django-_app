"""
Django settings for practiserev project.
...
SECRET_KEY = 'django-insecure-6237n=v0!1k12sx!))_g7v5rgs_^zr+@@%*2zg_$r#o+4=&tq7'
...
WSGI_APPLICATION = 'practiserev.wsgi.application'
