...
class ItemForm(forms.ModelForm):
    class Meta:
        ...
        widgets={
            "item_name":forms.TextInput(attrs={"placeholder":"E.g:French Fries","required":True}),
            "item_desc":forms.TextInput(attrs={"placeholder":"E.g:Dry and Salty","required":True}),
    ...
    def clean_item_price(self):
        ...
        if price<0:
            raise forms.ValidationError("Price cannot be negattive")
        return price
    ...
    def clean(self):
        ...
        if name and desc and name.lower() in desc.lower():
            self.add_error("item_desc","Description should be add new info beyond the name")
        return cleaned  